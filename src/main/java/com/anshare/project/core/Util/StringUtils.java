...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return 字符串
     */
    public static String commCovent(Object obj) {
     ...
     * 数字格式化
     * @param d 位数
     * @param formatText  #.000 格式 三位小数
     * @return 格式 三位小数
     */
    public static double commFormatter(double d, String formatText) {
     ...
     * @return Id's字符串
     */
	public static String idsConcatenation(String value){
		if(value.contains(",")){
	...
	//主键生成策略
	public static Boolean isGenerator(String str){
